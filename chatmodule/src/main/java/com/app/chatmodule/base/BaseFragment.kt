package com.app.chatmodule.base
...
open class BaseFragment : Fragment() {
    ...
    fun getChatId(receiverId : String) : String {
        val userId = SharedPreferenceUtil.getPreferences(activity, ChatConstant.USER_ID, "")
    ...
    fun getUserId(): String {
        return SharedPreferenceUtil.getPreferences(activity, ChatConstant.USER_ID, "").toString()
    }
}